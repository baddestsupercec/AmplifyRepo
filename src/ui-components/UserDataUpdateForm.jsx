      ...
      const record = userIDProp
        ? (
            await client.graphql({
              query: getUserData.replaceAll("__typename", ""),
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: updateUserData.replaceAll("__typename", ""),
            variables: {
              input: {
                userID: userDataRecord.userID,
                ...modelFields,
              },
            },
          });
    ...
    >
      ...
      >
        <Button
          ...
          isDisabled={!(userIDProp || userDataModelProp)}
