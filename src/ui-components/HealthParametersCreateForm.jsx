...
import { createHealthParameters } from "../graphql/mutations";
const client = generateClient();
export default function HealthParametersCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setPHlow(initialValues.pHlow);
    setPHhigh(initialValues.pHhigh);
    setTemperatureLow(initialValues.temperatureLow);
    setTemperatureHigh(initialValues.temperatureHigh);
    setHumidityLow(initialValues.humidityLow);
    setHumidityHigh(initialValues.humidityHigh);
    setSmellLow(initialValues.smellLow);
    setSmellHigh(initialValues.smellHigh);
    setMoistureLow(initialValues.moistureLow);
    setMoistureHigh(initialValues.moistureHigh);
    setLightLow(initialValues.lightLow);
    setLightHigh(initialValues.lightHigh);
    setErrors({});
  };
  const validations = {
    name: [{ type: "Required" }],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createHealthParameters.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "HealthParametersCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
